...
-- Create Database
-- ----------------------
CREATE DATABASE IF NOT EXISTS `nyumba_db` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `nyumba_db`;
...
('admin@nyumba.co.ke', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.W', 'Admin', 'Nyumba', 'admin');
...
('Government Announces KSh 50 Billion Affordable Housing Initiative',
 '<p>The Ministry of Housing has unveiled ambitious plans to deliver 200,000 affordable housing units across Kenya by 2025, with a strong focus on urban centers such as Nairobi, Mombasa, Kisumu, and Nakuru.</p><p>The initiative is expected to create over 500,000 jobs in the construction sector and stimulate growth in related industries including cement, steel, and real estate services.</p>',
...
('Revolutionary 3D Printing Technology Arrives in Nairobi',
 '<p>A local construction company has introduced cutting-edge 3D printing technology for faster and more efficient building construction, reducing costs by up to 40%.</p><p>The technology can construct a standard two-bedroom house in just 48 hours compared to the traditional 6-month timeline.</p>',
...
('Cement Prices Drop 15% as New Factory Opens in Machakos',
 '<p>The opening of a new cement manufacturing plant in Machakos County is expected to reduce construction costs significantly across Kenya.</p><p>Industry analysts predict that the increased supply will bring cement prices down from an average of KSh 720 to KSh 620 per 50kg bag.</p>',
...
('Green Building Certification Program Launched in Kenya',
 '<p>The Kenya Green Building Society has introduced new certification standards to promote environmentally sustainable construction practices nationwide.</p><p>Buildings certified under the new system are expected to use 30-50% less energy and 40% less water.</p>',
...
('Dr. Sarah Mwangi', 'Architect', 'Mwangi & Associates Architecture', 'Nairobi, Kenya', 'Award-winning architect specializing in sustainable and eco-friendly building designs with over 15 years of experience.', '["Sustainable Design","Commercial Buildings","Green Architecture","Urban Planning"]', 15, 5000.00, '["LEED AP","RIBA","BORAQS"]', 'https://images.pexels.com/photos/762020/pexels-photo-762020.jpeg?auto=compress&cs=tinysrgb&w=400', '+254 722 123 456', 'sarah@mwangiarch.co.ke', 'www.mwangiarchitecture.co.ke', 1, 1, 4.90, 127, 89),
...
('Peter Kamau', 'Civil Engineer', 'Kamau Civil Engineering Ltd', 'Nairobi, Kenya', 'Civil engineer specializing in road construction, drainage systems, and infrastructure development.', '["Road Construction","Drainage Systems","Site Development","Infrastructure Planning"]', 14, 4000.00, '["EBK Registration","IEK Member"]', 'https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg?auto=compress&cs=tinysrgb&w=400', '+254 722 456 789', 'peter@kamauce.co.ke', NULL, 1, 1, 4.60, 52, 43);
...
('Kenya Construction Expo 2025', 'The largest construction industry exhibition in East Africa featuring the latest technologies, materials, and innovations.', 'Exhibition', '2025-03-15', '09:00 AM', '2025-03-17', 'KICC, Nairobi', 'Kenyatta International Convention Centre', 2500.00, 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800', 'Kenya Association of Building & Civil Engineering Contractors', 5000, '["Dr. Sarah Mwangi","Eng. Michael Ochieng"]', 1, 'upcoming', 'https://kenyaconstructionexpo.com', 1),
('Sustainable Building Materials Conference', 'Exploring eco-friendly construction materials and sustainable building practices for the future.', 'Conference', '2025-04-28', '08:30 AM', '2025-04-28', 'Serena Hotel, Nairobi', 'Serena Hotel Conference Center', 3500.00, 'https://images.pexels.com/photos/416917/pexels-photo-416917.jpeg?auto=compress&cs=tinysrgb&w=800', 'Green Building Society of Kenya', 800, '["Prof. Jane Wambua","Dr. Tom Kariuki"]', 1, 'upcoming', NULL, 1),
('Real Estate Investment Summit', 'Connect with top investors, developers, and real estate professionals at Kenya''s premier property investment event.', 'Conference', '2025-05-10', '09:00 AM', '2025-05-10', 'Radisson Blu, Nairobi', 'Radisson Blu Upper Hill Hotel', 5000.00, 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800', 'Kenya Property Developers Association', 1200, '[]', 0, 'upcoming', NULL, 1);
...
('Construction Materials Catalog 2025', 'Complete guide to premium building materials', 'pdf', '/catalogs/materials-2025.pdf', 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800', 1, 1),
